...
<html>
  <head>
    ...
    <title>Nos fruits - Fruits Market</title>
  </head>
  <body> 
  	<style>
    ...
    <div class="site-header sticky-top">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light pr-5 pl-5">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <a class="navbar-brand" href="index">Fruits Market</a>
    ...
    <div class="row row-cols-1 row-cols-md-4">
	    <c:forEach var="productsFruits" items = "${ productsFruits }">
	        <div class="col mb-4">
	          <div class="card">
	            <img src="${ productsFruits.images }" class="card-img-top" alt="...">
	            <div class="card-body">
	              <h5 class="card-title">${ productsFruits.nomProduits }</h5>
	              <p class="card-text">${ productsFruits.prix } € ${ productsFruits.portions }</p>
