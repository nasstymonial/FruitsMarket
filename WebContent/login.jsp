...
<head>
<meta charset="UTF-8">
<title>Connexion - FruitsMarket</title>
<!-- Bootstrap CSS -->
	...
	<div class="container">
	    <div class="mx-auto">
	        ...
	        <form method="POST" action="Controller">
	            ...
	            <div class="form-group row">
	                <div class="col-sm-10">
	                <input type="password" class="form-control" id="inputPassword3" name="password" id="password" placeholder="Mot de passe" required>
	                </div>
	            </div>
	            <div class="form-group row">
	                <div class="col-sm-10">
	        ...
	        <p>
	       		Nouveau chez FruitsMarket ? <a href="Controller?page=sign-up">Créer un compte</a>
	        </p>
	    </div>
	</div>
