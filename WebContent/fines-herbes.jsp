...
<head>
<meta charset="UTF-8">
<title>Nos fines herbes - FruitsMarket</title>
    <!-- Bootstrap CSS -->
...
<body>
	...
	<h1 class="title-category display-3">Nos fines herbes</h1>
		
	<div class="row row-cols-1 row-cols-md-4">
		<c:forEach items="${list }" var="product">
	
			<c:if test="${product.getCategory() == 'fines-herbes' }">
		         	...
		         	<div class="card">
		           		...
		           		<div class="card-body">
			             	...
			             	<c:if test="${product.getStock() > 0 }">
							  	<a href="Controller?page=addtocart&action=fines-herbes&id=<c:out value="${product.getId()}"/>">
			           		...
			           		<c:if test="${product.getStock() == 0 }">
			           			<font color="#F24638"><h6>Rupture de stock</h6></font>
			           		</c:if>			             	
		           		</div>
		         	</div>
				</div>
