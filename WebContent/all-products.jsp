...
<head>
<meta charset="UTF-8">
<title>Tout nos produits - FruitsMarket</title>
    <!-- Bootstrap CSS -->
...
<body>
	...
	<h1 class="title-category display-3">Tout nos produits</h1>
         	...
         	<div class="card">
           		...
           		<div class="card-body">
	             	...
	             	<c:if test="${product.getStock() > 0 }">
					  	<a href="Controller?page=addtocart&action=allproducts&id=<c:out value="${product.getId()}"/>">
