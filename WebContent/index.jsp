...
<head>
<meta charset="UTF-8">
<title>Accueil - FruitsMarket</title>
    <!-- Bootstrap CSS -->
...
<body>
	...
	<h1 class="title-category display-3">Nos produits en vedette</h1>
		
	<div class="row row-cols-1 row-cols-md-4">
		<c:forEach items="${list }" var="product">
	
			<c:if test="${product.getFeatured() == 'oui' }">
           		...
           		<div class="card-body">
	             	...
	             	<p class="card-text"><c:out value="${ product.getPrice() }"></c:out> €</p>
	           		<c:if test="${product.getStock() > 0 }">
					  	<a href="Controller?page=addtocart&action=index&id=<c:out value="${product.getId()}" />">
